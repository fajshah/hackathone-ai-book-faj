...
const config: Config = {
  title: 'Faj Site',                  // Required
  tagline: 'Hello World From Faj',
  ...
  // Production URL
  url: 'http://localhost:3000',       // Local testing
  baseUrl: '/',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Faj Site. Built with Docusaurus.`,
    },
    prism: {
